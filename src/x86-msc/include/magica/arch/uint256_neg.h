...
static inline void mg_uint256_neg(mg_uint256_t *op1)
{
	...
	c = _addcarry_u32(c, op1->word[4], 0, &op1->word[4]);
	c = _addcarry_u32(c, op1->word[5], 0, &op1->word[5]);
	c = _addcarry_u32(c, op1->word[6], 0, &op1->word[6]);
	c = _addcarry_u32(c, op1->word[7], 0, &op1->word[7]);
}
